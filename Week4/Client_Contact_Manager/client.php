...
<article id = "main">
	...
	<div class="formGroup">
			<label>Phone</label>
			<input type='tel' pattern='[\+]\d{2}[\(]\d{2}[\)]\d{4}[\-]\d{4}' title='Phone Number (Format: +99(99)9999-9999)' name="phone" placeholder = "Valid Phone Number" required>
	</div>
	<div class="formGroup">
			<label>Email</label>
...
'</td><td><a href = "delete.php?id=' . $row['id'] . '">Delete</a></td><td><a href = "updateclient.php?id=' . $row['id'] . '">Update</a><br />';
}
?>
